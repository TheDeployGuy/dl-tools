    ...
    render() {
        ...
        <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter player name" />
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Player's Team</label>
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter players club e.g. D2" />
            </div>
            <div class="form-group">
